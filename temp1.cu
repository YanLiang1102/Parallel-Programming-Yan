    ...
    //for (i=1;i<=2^(EXPO-step)-1;i++)
     ...
     /*  if((tx!=(blockColumn-1))&&(ty!=(blockRow-1)))-----this is very import branch divergence happen here, need
     //to figure out how exactly cuda works!!
      {*/
        printf("does this ever got run?");
        printf("indide block tx %d \n",tx);
        printf("indide block ty %d \n",ty);
        ...
        if(step==2)
        {
         ...
         printf("index helper: %d \n",-step+helper1-helper4+2*(helper3));
         printf("ahelperfora1 in step 2 %f : \n",ahelperfora1);
         printf("ahelperfora2 in step 2 %f : \n",ahelperfora2);
         printf("bhelperfora1 in step 2 %f : \n",bhelperfora1);
        }
 ...
 /*           printf("deviceA[0]:%f \n",deviceA[0]);
        ...
        float bhelperforc2=deviceB[-step+helper1-helper4+2*(helper3)+1];
    ...
    if(step==8&&tx==0&&ty==0)
      {
            ...
            printf("deviceA in step8: %f \n",deviceA[511]);
         
        
            printf("deviceB in step8: %f \n",deviceB[511]);
         
      
            printf("deviceC in step8: %f \n",deviceC[511]);
         
      
      
            printf("deviceD in step8: %f \n",deviceD[511]);
